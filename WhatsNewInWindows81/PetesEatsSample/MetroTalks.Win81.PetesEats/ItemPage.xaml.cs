...
namespace MetroTalks.Win81.PetesEats
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        private EatItemViewModel defaultViewModel = new EatItemViewModel();
        ...
        /// </summary>
        public EatItemViewModel DefaultViewModel
        {
        ...
        {
            await DefaultViewModel.BindItem((int)e.NavigationParameter);
        }
